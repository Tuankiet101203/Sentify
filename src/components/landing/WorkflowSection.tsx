      ...
      <div className="relative mx-auto max-w-[1440px]">
        <div className="mb-14 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <p
            ...
            className="reveal-up max-w-lg text-base leading-8 text-text-silver-light dark:text-text-silver-dark"
          >
        ...
        <div className="grid gap-5 lg:grid-cols-4">
          {copy.workflow.steps.map((step, index) => (
            <article
              ...
              className="reveal-up relative rounded-[28px] border border-border-light bg-surface-white/90 p-6 shadow-sm transition-colors dark:border-border-dark dark:bg-surface-dark/80"
            >
