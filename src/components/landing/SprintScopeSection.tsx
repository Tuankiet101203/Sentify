  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px]">
        <div className="reveal-up mb-14 max-w-3xl">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(280px,0.8fr)]">
          <ScopeCard
            delay={200}
            title={copy.sprint.inScopeTitle}
            icon="task_alt"
            items={copy.sprint.inScopeItems}
          />
          <ScopeCard
            delay={320}
            title={copy.sprint.outOfScopeTitle}
            icon="block"
            items={copy.sprint.outOfScopeItems}
          />
          <article
